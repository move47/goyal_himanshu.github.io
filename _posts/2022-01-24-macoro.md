...
At the core of the coroutine specification os a relatively mechanical transformation. Every coroutine function is effectively transformed into two functions. The first (_outer function_) performs the following:
